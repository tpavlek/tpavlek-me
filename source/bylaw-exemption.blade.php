...
@section('content')
    ...
    <div class="text-center max-w-lg mx-auto mb-4">
        <div class="post-content text-white my-2 text-sm text-center mx-auto">
            ...
            <br/><br />Photo credit: <a href="https://twitter.com/davidbloomphoto">@davidbloomphoto</a>, <a href="https://edmontonjournal.com/news/local-news/city-of-edmonton-abruptly-ends-mask-exemption-card-distribution-after-four-days">Edmonton Journal</a>
        </div>
    </div>
