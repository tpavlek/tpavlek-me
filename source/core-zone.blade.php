...
@section('content')
    ...
    <div class="h-96 w-full bg-cover bg-center relative" style="background-image: url('/img/core-zone/yeg-core-zone.jpg')">

    </div>

    <div class="bg-green-900 text-white text-center p-8">
        <h1 class="text-4xl my-4">What is the #YEGCoreZone?</h1>

        <p class="text-xl leading-loose max-w-5xl text-left py-4 mx-auto">
    ...
    <div class="bg-white p-8 text-center">
        ...
        <p class="text-xl text-left leading-loose max-w-5xl mx-auto">
            ...
            <li>
                <strong class="text-yellow-600">yellow</strong> represents <strong class="text-yellow-dark">collector roadways</strong> which would be 40km/h inside the zone.
            </li>
            <li>
