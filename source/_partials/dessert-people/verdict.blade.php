<div class="bg-grey-100 rounded @if (!isset($preserve_margin) || !$preserve_margin) md:-mx-8 @endif @if (!isset($disable_shadow) || !$disable_shadow) shadow-md @endif relative overflow-hidden flex divide-x-2 divide-grey-400">
