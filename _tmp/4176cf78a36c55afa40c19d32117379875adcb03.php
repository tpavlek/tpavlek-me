...
<?php echo $__env->make('_partials.podcast', [ 'track_no' => 259574585 ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'fare-bus.jpg', 'caption' => "The cost of transit fares is too damn high!" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.signup', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
