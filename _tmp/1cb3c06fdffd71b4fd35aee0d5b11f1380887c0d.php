...
<?php echo $__env->make('_partials.signup', [ 'signup_extra' => "Troy grew up in government-subsidized housing. Let's enable all Edmontonians to grow out of it." ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
