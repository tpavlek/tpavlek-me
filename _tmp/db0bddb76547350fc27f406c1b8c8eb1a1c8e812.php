...
<?php echo $__env->make('_partials.image', ["name"=>"potato-cam.png", "caption" => "There are dozens of pixels! DOZENS!"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', ["name"=>"whos-that-councillor.png", "caption" => "One of them is actually Waldo, but the colours are so washed out, you'd never know."], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', ["name"=>"new-camera.png", "caption" => "itshappening.gif"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', ["name"=>"iveson-fabio.jpg", "caption" => "Hyper-sexualization of our mayor is not appropriate now that we can finally see him in high-resolution"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
