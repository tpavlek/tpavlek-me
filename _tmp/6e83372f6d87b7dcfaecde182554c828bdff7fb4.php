...
<?php echo $__env->make('_partials.image', [ 
...
<?php echo $__env->make('_partials.image', [ 'name' => 'tactical-urbanism.jpg', 'caption' => 'Some examples of inexpensive roadway treatments to increase safety' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'collision-reductions.jpg', 'caption' => 'Data from the city of Edmonton projecting the reduction in collisions from these speed changes' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'classifications.jpg', 'caption' => 'Both of these roadways are classified "Residential-Collector"' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
