...
<?php echo $__env->make('_partials.image', [ 'name' => 'take-a-risk.jpg', 'caption' => "The EEDC would love to see Edmonton seen as a quick-moving city of risk-takers" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'costs.jpg', 'caption' => "$14MM over four years has been spent running EEDC's marketing and Make Something Edmonton" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

What do you think? Reach out on [Twitter](<?php echo e($page->twitter_url); ?>) or join the conversation on [reddit](https://www.reddit.com/r/Edmonton/comments/6l8j8n/edmontons_new_oneword_brand_edmonton/).
