...
<?php echo $__env->make('_partials.image', [ 'name' => 'grid-network.jpg', 'caption' => '100 ave was getting dangerous with impatient drivers frustrated at cyclists not in the bike lane' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'yield-to-bikes.jpg', 'caption' => 'The bike lane has right-of-way over right-turning vehicles' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'left-turn-box.jpg', 'caption' => 'The bike boxes make it safe for cyclists to cross traffic' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'elephant-foot.jpg', 'caption' => 'White squares outside a crosswalk are called "Elephant\'s Foot"' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'calgary-bylaw.jpg', 'caption' => 'Calgary keeping its cyclists safe' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
