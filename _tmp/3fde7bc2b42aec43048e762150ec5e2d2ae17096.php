...
<?php echo $__env->make('_partials.image', [ "name" => "arena-rendering.jpg","caption" => "The proposed rendering of the new twin arena on South Campus" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ "name" => "van-vliet.jpg","caption" => "The new Van Vliet recreation complex, on main campus. Do I ever want to eat out of that KFC bowl" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
