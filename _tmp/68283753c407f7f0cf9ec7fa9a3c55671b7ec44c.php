...
<html>
<head>
    <title>Troy Pavlek: <?php echo $__env->yieldContent('title', "I lose elections"); ?></title>
    <meta charset="utf-8">
    ...
    <?php echo $__env->yieldContent('social_meta', ''); ?>
</head>
    ...
    <nav class="flex items-center justify-between flex-wrap bg-secondary">
        ...
        <div class="flex-grow flex items-center justify-end w-auto">
            ...
            <div class="text-sm lg:flex-grow">
                <a href="<?php echo e($page->twitter_url); ?>" class="text-white text-xl hover:text-gold p-2 mr-2 no-underline">
    ...
    <div class="inline-flex flex-col lg:flex-row mx-auto">
        ...
        <div class="flex-1 text-left p-2 lg:p-8">
            ...
            <p class="text-grey-light font-thin no-underline hover:border-b">
                <a href="<?php echo e($page->twitter_url); ?>" class="block text-grey-light font-thin no-underline hover:border-grey border-b-2 border-transparent">Twitter</a>
                <a href="<?php echo e($page->facebook_url); ?>" class="block text-grey-light font-thin no-underline hover:border-grey border-b-2 border-transparent">Facebook</a>
...
<?php if($page->google_analytics_tracking_id): ?>
<script type="text/javascript">
    ...
    ga('create', '<?php echo e($page->google_analytics_tracking_id); ?>', 'auto');
    ga('send', 'pageview');
</script>
<?php endif; ?>
</body>
