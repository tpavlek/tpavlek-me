...
<?php echo $__env->make('_partials.image', [ 'name' => 'self-driving-space.jpg', 'caption' => "A remix of the popular [Space required to transport 60 people](/img/posts/2017-09-22-self-driving-cars-will-not-solve-transit/transport-60.jpg) image" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'replace-trains.jpg', 'caption' => "Rusted LRT graveyards will fill the city" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.signup', [ 'signup_extra' => "Troy is committed to making transit a much more viable option for Edmontonians" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
