...
<?php echo $__env->make( '_partials.image', ['name' => 'readers.png'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make( '_partials.image', ['name' => 'gawker.png'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
