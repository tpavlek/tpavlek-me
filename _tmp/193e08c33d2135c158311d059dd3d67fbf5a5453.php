...
<?php echo $__env->make('_partials.posts.post-embed', [ 'slug' => 'a-quick-stop-in-idaho' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'alternating-problems.jpg', 'caption' => "The solution the City is looking for was developed in Idaho in 1982" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'mno.jpg', 'caption' => "The Mature Neighbourhood Overlay covers a lot of destinations" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.signup', [ 'signup_extra' => 'Yield straight through this sign-up form to quickly get your email updates' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
