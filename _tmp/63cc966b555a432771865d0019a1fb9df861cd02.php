...
<?php echo $__env->make('_partials.image', [ 'name' => 'panel-frames.jpg', 'caption' => 'A couple completed frames' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.youtube', [ 'video_id' => 'RAyFYWOlFOs'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
