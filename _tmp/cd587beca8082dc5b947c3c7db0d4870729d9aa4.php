...
<?php echo $__env->make('_partials.image', [ "name" => "maturity.jpg","caption" => "It took all my willpower not to turn the first point into a dig at the Smart Travel app" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', ["name" => "panel.jpg","caption" => "Photo credit to @geodarcy on Twitter"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', ["name" => "jeopardy.jpg","caption" => "What is BIG SHINY BALLS?"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
