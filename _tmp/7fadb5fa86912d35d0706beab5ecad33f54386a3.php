...
<?php echo $__env->make('_partials.image', ["name" => "fixed-vs-moving-block.jpg", "caption" => "Wikipedia provides a solid visualization for the advantages"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
