...
<?php echo $__env->make('_partials.youtube', [ 'video_id' => '7M8-wTx1fjo' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ 'name' => 'society-costs.jpg', 'caption' => "Private car usage carries a high societal cost - that we all subsidize" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.posts.post-embed', [ 'slug' => 'keeping-our-sidewalks-clear' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.signup', [ 'signup_extra' => "Troy doesn't need any encouragement to get out on the streets. He walks exactly what he talks." ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
