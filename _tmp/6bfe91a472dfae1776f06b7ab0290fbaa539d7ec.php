...
<div class="signup-box">
    ...
    <?php if(isset($signup_extra)): ?>
        <p>
            <?php echo $signup_extra; ?>
    ...
    <div style="display:flex; align-items: center;">
        <a class="twitter-follow-button" href="<?php echo e($page->twitter_url); ?>" data-size="large">Follow @troypavlek</a>

        <div style="flex-grow:1;">
            <a class="button" href="<?php echo e($page->facebook_url); ?>"><i class="fa fa-facebook"></i> Facebook</a>
        </div>
