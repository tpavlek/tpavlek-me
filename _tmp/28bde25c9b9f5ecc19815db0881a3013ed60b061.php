...
<?php echo $__env->make('_partials.image', ['name' => 'skyline.jpg', 'caption' => "A rendering of Edmonton's skyline with the new tower"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', ['name' => 'metro-line-fast.jpg', 'caption' => 'Gotta go fast!'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
That's all for this week! If you think these updates are useful, please give me a [follow on Twitter](<?php echo e($page->twitter_url); ?>)
or a [follow on Facebook](<?php echo e($page->facebook_url); ?>) and let me know.
