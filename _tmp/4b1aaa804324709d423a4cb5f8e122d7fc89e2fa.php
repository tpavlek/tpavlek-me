<?php $__env->startSection('title', 'Vision Zero'); ?>
...
<article class="mx-auto bg-white shadow">
    <div class="post-content post-text">
        ...
        <?php echo $__env->make('_partials.posts.post-embed', [ 'slug' => 'whos-to-blame-for-pedestrian-collisions' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <?php echo $__env->make('_partials.posts.post-embed', [ 'slug' => 'edmonton-technology-strategy-continues-to-embarass' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <?php echo $__env->make('_partials.posts.post-embed', [ 'slug' => 'idaho-stops-mature-neighbourhoods' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<div class="">
    <?php $__currentLoopData = $page->tagged($posts, 'vision-zero'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
