...
<?php echo $__env->make('_partials.image', [ 'name' => 'idaho-stops.jpg' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('_partials.image', [ "name" => "bike-box.jpg","caption" => "I'm confident many drivers that see cyclists cut in front of them in Bike Boxes think a law is being broken" ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
