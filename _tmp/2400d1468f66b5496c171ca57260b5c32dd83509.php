...
<?php echo $__env->make('_partials.image', ['name' => 'drop-in.jpg', 'caption' => 'Drops are a good unit' ], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

Expect to see the same for BETA 2, once winners have received their prizes! It's a lot of fun! If you want to keep up 
with events like these (and maybe even win your own crayon drawing), consider following me on [Twitter](<?php echo e($page->twitter_url); ?>)
